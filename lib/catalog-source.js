...
async function getCatalog() {
  ...
  // Nog geen Shopify (test of echt) geconfigureerd -> terugvallen op de
  // handmatige placeholders zodat de site tijdens de vroegste ontwikkelfase
  // nog steeds bruikbaar is.
...
function getCatalogSourceLabel() {
  ...
  return 'Placeholder-data (nog geen Shopify geconfigureerd)';
}
